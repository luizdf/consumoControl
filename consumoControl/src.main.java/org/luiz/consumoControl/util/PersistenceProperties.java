package org.luiz.consumoControl.util;
...
public class PersistenceProperties {
    ...
    private static Properties userHomeJdbcFile() throws Exception {
        ...
        File fileProperties = new File(System.getProperty("user.home") + System.getProperty("file.separator") + 
        		                       "Java" + System.getProperty("file.separator") + "BD", "jdbc.properties");
        
        if (fileProperties.exists()) {
            props.load(new FileInputStream(fileProperties));
        } else{
        	System.out.println("Atenção, não foi encontrado o arquivo jdbc.properties no diretório: " + 
                               System.getProperty("user.home") + System.getProperty("file.separator") + 
                               "Java" + System.getProperty("file.separator") + "BD");
        }
